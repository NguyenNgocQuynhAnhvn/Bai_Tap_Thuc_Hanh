...
# bai1 cho biet ngay va gia co phieu cac nhat vao thoi diem dong cua
# FROM Stock
# SELECT _date, closing_price
# WHERE closing_price = SELECT(MAX(closing_price)FROM Stock)

# bai2 cho biet gia co phieu thap nhat vao luc dong cua
# From Stock
# WHERE closing_price = MIN(closing_price) FROM Stock)

# bai3 trung binh gia co phieu trong 30 ngay vao gio dong cua
# SELECT AVG(closing_price) as Average
# FROM (
    # SELECT TOP 30 closing_price
    # FROM Stock
    # ORDER BY date DESC
#) as last_30_days